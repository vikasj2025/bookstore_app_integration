...
export function Footer() {
  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: 'New Releases', href: '/books?sort=createdAt,desc' },
        { name: 'Bestsellers', href: '/books?sort=popular,desc' },
        { name: 'Sale', href: '/books?sale=true' },
      ],
    },
    {
      title: 'Account',
  ...
  const socialLinks = [
    {
      name: 'Facebook',
      href: 'https://facebook.com/onlinebookstore',
      icon: (
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/onlinebookstore',
      icon: (
        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Your trusted online destination for books across all genres. 
              Discover your next great read with fast shipping and excellent service.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-col sm:flex-row gap-2 max-w-md">
              ...
              />
              <button className="px-6 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-md transition-colors whitespace-nowrap">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              <p>&copy; {currentYear} Online Bookstore. All rights reserved.</p>
            </div>
